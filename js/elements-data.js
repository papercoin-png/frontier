...
// CORRECTED: All rarities now match galaxy-data.js tier definitions

export const ELEMENTS = [
    // ===== COMMON (TIER 1) - 100 credits each =====
    { name: 'Aluminum', symbol: 'Al', atomic: 13, mass: '26.98', rarity: 'common', planets: 378, value: 100 },
    { name: 'Argon', symbol: 'Ar', atomic: 18, mass: '39.95', rarity: 'common', planets: 178, value: 100 },
    ...
    { name: 'Carbon', symbol: 'C', atomic: 6, mass: '12.01', rarity: 'common', planets: 534, value: 100 },
    { name: 'Chlorine', symbol: 'Cl', atomic: 17, mass: '35.45', rarity: 'common', planets: 245, value: 100 },
    { name: 'Fluorine', symbol: 'F', atomic: 9, mass: '19.00', rarity: 'common', planets: 234, value: 100 },
    ...
    { name: 'Neon', symbol: 'Ne', atomic: 10, mass: '20.18', rarity: 'common', planets: 198, value: 100 },
    { name: 'Nitrogen', symbol: 'N', atomic: 7, mass: '14.01', rarity: 'common', planets: 512, value: 100 },
    { name: 'Oxygen', symbol: 'O', atomic: 8, mass: '16.00', rarity: 'common', planets: 498, value: 100 },
    { name: 'Phosphorus', symbol: 'P', atomic: 15, mass: '30.97', rarity: 'common', planets: 267, value: 100 },
    ...
    { name: 'Sulfur', symbol: 'S', atomic: 16, mass: '32.06', rarity: 'common', planets: 289, value: 100 },
    
    // ===== UNCOMMON (TIER 2) - 250 credits each =====
    { name: 'Antimony', symbol: 'Sb', atomic: 51, mass: '121.8', rarity: 'uncommon', planets: 3, value: 250 },
    { name: 'Arsenic', symbol: 'As', atomic: 33, mass: '74.92', rarity: 'uncommon', planets: 11, value: 250 },
    { name: 'Barium', symbol: 'Ba', atomic: 56, mass: '137.3', rarity: 'uncommon', planets: 4, value: 250 },
    { name: 'Bromine', symbol: 'Br', atomic: 35, mass: '79.90', rarity: 'uncommon', planets: 8, value: 250 },
    { name: 'Cadmium', symbol: 'Cd', atomic: 48, mass: '112.4', rarity: 'uncommon', planets: 3, value: 250 },
    { name: 'Cerium', symbol: 'Ce', atomic: 58, mass: '140.1', rarity: 'uncommon', planets: 3, value: 250 },
    { name: 'Cesium', symbol: 'Cs', atomic: 55, mass: '132.9', rarity: 'uncommon', planets: 4, value: 250 },
    { name: 'Copper', symbol: 'Cu', atomic: 29, mass: '63.55', rarity: 'uncommon', planets: 23, value: 250 },
    { name: 'Dysprosium', symbol: 'Dy', atomic: 66, mass: '162.5', rarity: 'uncommon', planets: 2, value: 250 },
    { name: 'Erbium', symbol: 'Er', atomic: 68, mass: '167.3', rarity: 'uncommon', planets: 2, value: 250 },
    { name: 'Europium', symbol: 'Eu', atomic: 63, mass: '152.0', rarity: 'uncommon', planets: 2, value: 250 },
    { name: 'Gadolinium', symbol: 'Gd', atomic: 64, mass: '157.3', rarity: 'uncommon', planets: 2, value: 250 },
    { name: 'Gallium', symbol: 'Ga', atomic: 31, mass: '69.72', rarity: 'uncommon', planets: 15, value: 250 },
    { name: 'Germanium', symbol: 'Ge', atomic: 32, mass: '72.63', rarity: 'uncommon', planets: 12, value: 250 },
    { name: 'Holmium', symbol: 'Ho', atomic: 67, mass: '164.9', rarity: 'uncommon', planets: 2, value: 250 },
    { name: 'Indium', symbol: 'In', atomic: 49, mass: '114.8', rarity: 'uncommon', planets: 3, value: 250 },
    { name: 'Iodine', symbol: 'I', atomic: 53, mass: '126.9', rarity: 'uncommon', planets: 4, value: 250 },
    { name: 'Iron', symbol: 'Fe', atomic: 26, mass: '55.85', rarity: 'uncommon', planets: 412, value: 250 },
    { name: 'Krypton', symbol: 'Kr', atomic: 36, mass: '83.80', rarity: 'uncommon', planets: 7, value: 250 },
    { name: 'Lanthanum', symbol: 'La', atomic: 57, mass: '138.9', rarity: 'uncommon', planets: 3, value: 250 },
    { name: 'Lead', symbol: 'Pb', atomic: 82, mass: '207.2', rarity: 'uncommon', planets: 156, value: 250 },
    { name: 'Lutetium', symbol: 'Lu', atomic: 71, mass: '175.0', rarity: 'uncommon', planets: 2, value: 250 },
    { name: 'Magnesium', symbol: 'Mg', atomic: 12, mass: '24.31', rarity: 'uncommon', planets: 398, value: 250 },
    { name: 'Molybdenum', symbol: 'Mo', atomic: 42, mass: '95.95', rarity: 'uncommon', planets: 3, value: 250 },
    { name: 'Neodymium', symbol: 'Nd', atomic: 60, mass: '144.2', rarity: 'uncommon', planets: 2, value: 250 },
    { name: 'Nickel', symbol: 'Ni', atomic: 28, mass: '58.69', rarity: 'uncommon', planets: 234, value: 250 },
    { name: 'Niobium', symbol: 'Nb', atomic: 41, mass: '92.91', rarity: 'uncommon', planets: 3, value: 250 },
    { name: 'Palladium', symbol: 'Pd', atomic: 46, mass: '106.4', rarity: 'uncommon', planets: 2, value: 250 },
    { name: 'Praseodymium', symbol: 'Pr', atomic: 59, mass: '140.9', rarity: 'uncommon', planets: 2, value: 250 },
    { name: 'Rhodium', symbol: 'Rh', atomic: 45, mass: '102.9', rarity: 'uncommon', planets: 2, value: 250 },
    { name: 'Rubidium', symbol: 'Rb', atomic: 37, mass: '85.47', rarity: 'uncommon', planets: 6, value: 250 },
    { name: 'Ruthenium', symbol: 'Ru', atomic: 44, mass: '101.1', rarity: 'uncommon', planets: 2, value: 250 },
    { name: 'Samarium', symbol: 'Sm', atomic: 62, mass: '150.4', rarity: 'uncommon', planets: 2, value: 250 },
    { name: 'Selenium', symbol: 'Se', atomic: 34, mass: '78.97', rarity: 'uncommon', planets: 9, value: 250 },
    { name: 'Silver', symbol: 'Ag', atomic: 47, mass: '107.9', rarity: 'uncommon', planets: 8, value: 250 },
    { name: 'Strontium', symbol: 'Sr', atomic: 38, mass: '87.62', rarity: 'uncommon', planets: 5, value: 250 },
    { name: 'Tellurium', symbol: 'Te', atomic: 52, mass: '127.6', rarity: 'uncommon', planets: 3, value: 250 },
    { name: 'Terbium', symbol: 'Tb', atomic: 65, mass: '158.9', rarity: 'uncommon', planets: 2, value: 250 },
    { name: 'Thulium', symbol: 'Tm', atomic: 69, mass: '168.9', rarity: 'uncommon', planets: 2, value: 250 },
    { name: 'Tin', symbol: 'Sn', atomic: 50, mass: '118.7', rarity: 'uncommon', planets: 15, value: 250 },
    { name: 'Xenon', symbol: 'Xe', atomic: 54, mass: '131.3', rarity: 'uncommon', planets: 5, value: 250 },
    { name: 'Ytterbium', symbol: 'Yb', atomic: 70, mass: '173.0', rarity: 'uncommon', planets: 2, value: 250 },
    { name: 'Yttrium', symbol: 'Y', atomic: 39, mass: '88.91', rarity: 'uncommon', planets: 4, value: 250 },
    { name: 'Zinc', symbol: 'Zn', atomic: 30, mass: '65.38', rarity: 'uncommon', planets: 19, value: 250 },
    { name: 'Zirconium', symbol: 'Zr', atomic: 40, mass: '91.22', rarity: 'uncommon', planets: 4, value: 250 },
    
    // ===== RARE (TIER 3) - 1000 credits each =====
    ...
    // ===== VERY RARE (TIER 4) - 5000 credits each =====
    { name: 'Actinium', symbol: 'Ac', atomic: 89, mass: '227.0', rarity: 'very-rare', planets: 2, value: 5000 },
    { name: 'Americium', symbol: 'Am', atomic: 95, mass: '243.0', rarity: 'very-rare', planets: 1, value: 5000 },
    { name: 'Curium', symbol: 'Cm', atomic: 96, mass: '247.0', rarity: 'very-rare', planets: 1, value: 5000 },
    { name: 'Neptunium', symbol: 'Np', atomic: 93, mass: '237.0', rarity: 'very-rare', planets: 1, value: 5000 },
    { name: 'Plutonium', symbol: 'Pu', atomic: 94, mass: '244.0', rarity: 'very-rare', planets: 1, value: 5000 },
    ...
    // ===== LEGENDARY (TIER 5) - 25000 credits each =====
    ...
    { name: 'Bismuth', symbol: 'Bi', atomic: 83, mass: '209.0', rarity: 'legendary', planets: 4, value: 25000 },
    ...
    { name: 'Hafnium', symbol: 'Hf', atomic: 72, mass: '178.5', rarity: 'legendary', planets: 2, value: 25000 },
    ...
    { name: 'Mercury', symbol: 'Hg', atomic: 80, mass: '200.6', rarity: 'legendary', planets: 5, value: 25000 },
    ...
    { name: 'Scandium', symbol: 'Sc', atomic: 21, mass: '44.96', rarity: 'legendary', planets: 23, value: 25000 },
    { name: 'Seaborgium', symbol: 'Sg', atomic: 106, mass: '269.0', rarity: 'legendary', planets: 1, value: 25000 },
    { name: 'Tantalum', symbol: 'Ta', atomic: 73, mass: '180.9', rarity: 'legendary', planets: 2, value: 25000 },
    ...
    { name: 'Thallium', symbol: 'Tl', atomic: 81, mass: '204.4', rarity: 'legendary', planets: 3, value: 25000 },
    { name: 'Tungsten', symbol: 'W', atomic: 74, mass: '183.8', rarity: 'legendary', planets: 3, value: 25000 }
];
